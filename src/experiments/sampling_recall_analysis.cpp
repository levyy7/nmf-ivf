...
int main() {
    ...
    std::vector<int> sample_sizes = {5000, 7500, 10000, 25000, 50000, 75000, 100000, 150000, 200000, 300000};
    ...
    for (int ss : sample_sizes) {
        ...
        std::string dir_path = "output/sampling_experiment/sample_" + std::to_string(ss);
